...
/***************************************************************************
 NewRaptor
                                 A QGIS plugin
 Add a new raptor and create buffer
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2026-03-08
        git sha              : $Format:%H$
        copyright            : (C) 2026 by gteam LLC
...
class NewRaptor:
    ...
    def run(self):
        ...
        self.dlg.spbLongtitude.setValue(mc.center().x())
        ...
        if missing_layers:
            msg="The following layers are missinf from this project\n"
        ...
        if result:
            ...
            idxNestID=lyrNests.fields().indexOf("Nest_ID") #現在のnestIDのインデックスを取得
            valNestID=lyrNests.maximumValue(idxNestID)+1 #インデックスの最大値に1を足してそこにデータを追加する
            valLat=self.dlg.spbLatitude.value()
            valLng=self.dlg.spbLongtitude.value()
